...
Shop.create(category_id: 4, name: 'Otherwild', description: 'Otherwild is a queer-identified woman-owned store, design studio and event space located in Los Angeles and online, centering ethics at the core of our business', social_impact: , address: '1768 N. Vermont Ave., Los Angeles, CA 90027', website: 'otherwild.com')
